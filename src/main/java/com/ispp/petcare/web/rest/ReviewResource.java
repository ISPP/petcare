...
public class ReviewResource {
    ...
    @RequestMapping(value = "/reviews",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<Review>> getAllReviews(Pageable pageable, @RequestParam(required = false) String filter)
        throws URISyntaxException {
        if ("booking-is-null".equals(filter)) {
            log.debug("REST request to get all Reviews where booking is null");
