...
public class AdministratorResourceIntTest {
    ...
    public void setup() {
        ...
        ReflectionTestUtils.setField(administratorResource, "administratorSearchRepository", administratorSearchRepository);
        ReflectionTestUtils.setField(administratorResource, "administratorRepository", administratorRepository);
