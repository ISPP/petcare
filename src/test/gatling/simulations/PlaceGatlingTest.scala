...
class PlaceGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Place entity")
        ...
        .repeat(2) {
            ...
            .post("/api/places")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "address":"SAMPLE_TEXT", "city":"SAMPLE_TEXT", "hasGarden":null, "hasPatio":null, "building":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
